...
// Images
// import WorkerSingle from '~images/team/worker-single.jpg';
				...
				<Row>
					...
					<Col className="col-12 col-lg-7">
						...
						<ul className="member-info">
							...
							<li>
								<strong>Website:</strong> <a href="https://www.sitename.com/" target="_blank" rel="noreferrer">https://www.sitename.com/</a>
							</li>
							<li>
